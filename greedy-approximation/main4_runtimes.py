...
run_times_ris_with_frac = [float(0)]
...
fstr = results_folder_runtime_files+os.sep+'runtime_info_ris_all_'+str(int(np.random.rand()*1000))+'.txt'
...
"log scale plot"           
ax = output_df.plot(lw=2,marker='o',logy=True)
ax.set_xlabel('Budget')
